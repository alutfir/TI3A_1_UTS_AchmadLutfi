...
public class Detail_kota extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_kota);dbHelper = new DataHelper(this);
    ...
    private void goToCek(){
        Intent mIntent = new Intent(getApplicationContext(),ListKota.class);
